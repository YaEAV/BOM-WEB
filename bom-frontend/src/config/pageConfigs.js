// src/config/pageConfigs.js (Corrected)
...
export const materialPageConfig = {
    ...
    getExtraParams: () => ({}), // <-- FIX: Added missing function
};
...
export const recycleBinConfigs = {
    ...
    versions: createRecycleBinConfig(versionService, versionPageConfig.columns.slice(0, 2), '搜索已删除的BOM版本...'),
